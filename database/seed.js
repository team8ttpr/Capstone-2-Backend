const { db, User, Posts, Follows } = require("./index"); // Changed from "./database" to "./index"

const seedDatabase = async () => {
  try {
    // Force sync with alter to update existing tables
    ...
    const users = await User.bulkCreate([
      {
        ...
        firstName: "Sarah",
        lastName: "Johnson",
        bio: "Love discovering new music and sharing my favorites!",
      ...
      },
      {
        ...
        firstName: "Mike",
        lastName: "Chen",
        bio: "Vinyl enthusiast and classic rock aficionado. Always hunting for rare records.",
      ...
      },
      {
        ...
        firstName: "Alex",
        lastName: "Rivera",
        bio: "Jazz musician and music producer. Sharing smooth vibes and hidden gems.",
      ...
      },
      {
        ...
        firstName: "Taylor",
        lastName: "Swift",
        bio: "Indie rock enthusiast and concert photographer. Living for live music experiences.",
